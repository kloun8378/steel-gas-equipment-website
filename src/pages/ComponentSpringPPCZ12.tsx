...
const PRODUCT_PRICE = '2 745 ₽';
const PRODUCT_NAME = 'Пружина ППЦЗ-12';
const PRODUCT_ID = 'spring-ppcz12';
const CANONICAL = 'https://стальпро.com/components/spring-ppcz12/index.html';
...
const breadcrumbLd = JSON.stringify({
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Пружина ППЦЗ-12', item: CANONICAL },
  ],
});
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Пружина предохранительного клапана ППЦЗ-12 для замены в старом клапане. Оригинальная деталь. Цена 2 745 ₽. В наличии на складе в Барнауле. Доставка по РФ."
        />
        <meta
          name="keywords"
        ...
        <meta property="og:title" content="Пружина ППЦЗ-12 — СтальПроКлапан" />
      ...
      <main className="container mx-auto px-4 md:px-6 py-6 sm:py-8">
        <div className="max-w-3xl mx-auto">
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-6">
            ...
            <Icon name="ChevronRight" className="h-4 w-4" />
            <span className="text-gray-700">Пружина ППЦЗ-12</span>
          </nav>

          <div className="mb-8">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">
              Купить пружину ППЦЗ-12
            </h1>
          ...
          <Card className="max-w-sm mx-auto hover:shadow-lg transition-shadow">
            <CardContent className="text-center p-6">
                ...
                {showSpecs && (
                  <div className="absolute left-0 right-0 top-full z-50 bg-white rounded-lg shadow-xl border mt-1 text-left">
                    <div className="bg-gray-50 p-3 border-b flex justify-between items-center">
                      <h3 className="text-sm font-bold text-gray-900">Пружина ППЦЗ-12</h3>
                      <button onClick={(e) => { e.stopPropagation(); setShowSpecs(false); }} className="text-gray-400 hover:text-gray-600">
                        <Icon name="X" className="h-4 w-4" />
                      </button>
                    </div>
                    <div className="p-3 space-y-2 text-sm">
                      <p className="text-gray-700">Пружина предохранительного клапана применяется в клапане ППЦЗ-12.</p>
                      <p className="text-gray-700">Служит для замены пружины в старом клапане, которая потеряла свои свойства.</p>
                    </div>
                  </div>
                )}
              </div>
              ...
              <Button className="w-full mb-2" size="lg" variant="outline" asChild>
                <a href="https://www.ozon.ru/product/pruzhina-k-predohranitelnomu-klapanu-pptsz-12-3084160991/" target="_blank" rel="noopener noreferrer">
