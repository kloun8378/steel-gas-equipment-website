      ...
      <main className="container mx-auto px-4 md:px-6 py-6 sm:py-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap gap-2 mb-8">
            ...
            <a href="/components/flange4-ppcz12" className="px-3 py-1 rounded-full text-sm border border-primary text-primary hover:bg-primary hover:text-white transition-colors">4 отверстия</a>
            <a href="/components/flange8-ppcz12" className="px-3 py-1 rounded-full text-sm border border-gray-300 text-gray-600 hover:border-primary hover:text-primary transition-colors">8 отверстий</a>
          </div>
