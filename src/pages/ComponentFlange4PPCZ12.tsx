...
const CANONICAL = 'https://стальпро.com/components/flange4-ppcz12/index.html';
...
const productLd = JSON.stringify({
  ...
  name: PRODUCT_NAME,
  image: PRODUCT_IMAGE,
  description: 'Фланец предохранительной арматуры на 4 отверстия для автоцистерн и резервуаров СУГ. Совместим с клапаном ППЦЗ-12.',
  ...
  const handleAddToCart = () => {
    if (user) {
      addToCart({
        ...
        image: PRODUCT_IMAGE,
        description: 'Фланец предохранительной арматуры на 4 отверстия для автоцистерн и резервуаров СУГ',
        quantity,
      });
    }
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Фланец предохранительной арматуры на 4 отверстия для автоцистерн и резервуаров СУГ. Совместим с клапаном ППЦЗ-12. Цена 4 372 ₽. В наличии в Барнауле."
        />
        <meta
          name="keywords"
          content="фланец на 4 отверстия ППЦЗ-12, фланец предохранительной арматуры, фланец для автоцистерны, фланец резервуар СУГ"
        />
        <meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1" />
        <link rel="canonical" href={CANONICAL} />
        <meta property="og:title" content="Фланец на 4 отверстия к ППЦЗ-12 — СтальПроКлапан" />
        <meta property="og:description" content="Фланец предохранительной арматуры на 4 отверстия для автоцистерн и резервуаров СУГ. Цена 4 372 ₽ с НДС." />
        <meta property="og:url" content={CANONICAL} />
        <meta property="og:type" content="product" />
        <meta property="og:image" content={PRODUCT_IMAGE} />
        <meta property="og:image:alt" content="Фланец на 4 отверстия к клапану ППЦЗ-12" />
      ...
      <main className="container mx-auto px-4 md:px-6 py-6 sm:py-8">
        <div className="max-w-3xl mx-auto">
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-6">
            ...
            <Icon name="ChevronRight" className="h-4 w-4" />
            <span className="text-gray-700">Фланец на 4 отверстия</span>
          </nav>

          <div className="mb-8">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">
              Купить фланец на 4 отверстия к ППЦЗ-12
            </h1>
          ...
          <div className="flex flex-wrap gap-2 mb-8">
            ...
            <a href="/components/flange4-ppcz12/index.html" className="px-3 py-1 rounded-full text-sm border border-primary text-primary hover:bg-primary hover:text-white transition-colors">4 отверстия</a>
            <a href="/components/flange8-ppcz12/index.html" className="px-3 py-1 rounded-full text-sm border border-gray-300 text-gray-600 hover:border-primary hover:text-primary transition-colors">8 отверстий</a>
          </div>
          ...
          <Card className="max-w-sm mx-auto hover:shadow-lg transition-shadow">
            <CardContent className="text-center p-6">
              ...
              <Button className="w-full mb-2" size="lg" variant="outline" asChild>
                <a href="https://www.ozon.ru/product/flanets-dlya-pptsz-12-07-00-000-3527815507/" target="_blank" rel="noopener noreferrer">
