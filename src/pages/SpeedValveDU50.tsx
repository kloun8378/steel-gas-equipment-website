...
const techSpecs = [
  ...
  { label: 'Диаметр клапана, A (мм)', value: '106' },
  { label: 'Строительная длина, B (мм)', value: '50' },
  { label: 'Высота, C (мм)', value: '54' },
  ...commonSpecs.slice(4),
];
...
const CANONICAL = 'https://стальпро.com/speed-valve/tpa11-050/index.html';
...
const breadcrumbLd = JSON.stringify({
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'ТПА11-050 ДУ50 PN40', item: CANONICAL },
  ],
});
...
export default function SpeedValveDU50() {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>Скоростной межфланцевый клапан ТПА11-050 ДУ50 PN40 купить — СтальПроКлапан</title>
        <meta
          name="description"
          content="Скоростной межфланцевый клапан ТПА11-050 ДУ50 PN40 для СУГ. Аварийное отключение потока. АГЗС, ГНС, автоцистерны. Цена 10 065 ₽. В наличии. Звоните!"
        />
        <meta
          name="keywords"
          content="Скоростной межфланцевый клапан, скоростной клапан ДУ50, ТПА11-050, клапан межфланцевый ДУ50 СУГ, скоростной клапан ДУ50 купить, клапан ДУ50 АГЗС, ТП11 ДУ50, скоростной клапан ДУ50 PN40"
        />
        ...
        <meta
          ...
          content="Скоростной клапан межфланцевый ТПА11-050 ДУ50 для СУГ. Цена 10 065 ₽ с НДС. В наличии."
        />
      ...
      <main className="container mx-auto px-4 md:px-6 py-6 sm:py-8">
        <div className="max-w-3xl mx-auto">
          ...
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-6">
            ...
            <Icon name="ChevronRight" className="h-4 w-4" />
            <span className="text-gray-700">ТПА11-050 ДУ50 PN40</span>
          </nav>

          <div className="mb-6">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">
              Купить скоростной межфланцевый клапан ТПА11-050 ДУ50 PN40
            </h1>
          ...
          <SpeedValveProductCard
            id={PRODUCT_ID}
            name={PRODUCT_NAME}
            description="Самый производительный межфланцевый клапан линейки ДУ50 для крупных объектов — автоцистерн и АГЗС с высоким расходом СУГ"
            price={PRODUCT_PRICE}
