...
const PRODUCT_NAME = 'Фланец 100-1-01-1-B-Ст 20-I-dв 116 ГОСТ 33259-2015';
const PRODUCT_ID = 'flange-100-1-01-1-b-st20-dv116';
...
const techSpecs = [
  ...
  { label: 'dв табличный диаметр отверстия', value: '116 мм' },
  ...
  { label: 'Внутренний диаметр', value: '116 мм' },
...
export default function FlangesType01BDv116() {
  ...
  return (
    ...
    <Helmet>
      ...
      <meta name="keywords" content="фланец 100-1-01-1-B dв116, фланец ГОСТ 33259-2015 Ду100, фланец плоский приварной Ру16, фланец Ст20 ГОСТ 33259-2015, фланец тип 01 исп B, СтальПроКлапан Барнаул" />
      <meta property="og:title" content="Фланец 100-1-01-1-B-Ст 20-I-dв 116 ГОСТ 33259-2015 — СтальПроКлапан" />
      <meta property="og:description" content="Плоский приварной фланец Ду-100, Ру-16, исполнение B, dв 116. Цена 1 241 ₽ с НДС. В наличии." />
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <nav className="text-sm text-gray-500 mb-6">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-900">Тип 01, исполнение B, dв 116</span>
        </nav>

        {/* Title */}
        <div className="mb-10 text-center">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            Фланец стальной плоский приварной тип 01 ГОСТ 33259-2015 исп B, dв 116
          </h1>
          <div className="flex items-center justify-center gap-2 mb-2">
            <span className="text-yellow-400 text-xl">★★★★★</span>
            <span className="text-sm text-gray-600">4.8 — <a href="/reviews/index.html" className="underline hover:text-primary">6 отзывов</a></span>
          </div>
        </div>
          ...
          <CardContent className="p-6 flex flex-col flex-1">
            ...
            <div className="text-center flex flex-col flex-1">
              ...
              <p className="text-sm text-gray-600 mb-3">
                Плоский приварной фланец с проходом Ду-100 на давление Ру-16, dв 116. Монтаж насадкой на трубу с обваркой двумя угловыми швами.
              </p>
        ...
        <section className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8 mt-8 max-w-3xl mx-auto">
          ...
          <p className="text-gray-600 leading-relaxed mb-3">
            Фланец плоский стальной 100-1-01-1-B-Ст.20-I ГОСТ 33259-2015 — плоский приварной фланец по ГОСТ 33259-2015 с проходом Ду-100 на давление Ру-16, табличным диаметром отверстия dв 116 мм. Монтаж — насадкой на трубу с обваркой двумя угловыми швами. Размеры по ГОСТ 33259-2015, ряд 1.
          </p>
