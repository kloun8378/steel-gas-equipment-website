...
export default function SafetyValve() {
  ...
  return (
    ...
    <Helmet>
      ...
      <meta name="keywords" content="предохранительный клапан ППЦЗ-12, ППЦЗ-12 купить, ППЦЗ-12 цена, ППЦЗ-12 характеристики, клапан предохранительный СУГ, аналог REGO RS3132, аналог REGO CD32, аналог ПК-32-Л, предохранительный клапан для АГЗС, предохранительный клапан резервуар СУГ, предохранительный клапан автоцистерна, клапан 1.6 МПа СУГ, запчасти ППЦЗ-12, пружина ППЦЗ-12, золотник ППЦЗ-12, ремкомплект ППЦЗ-12, предохранительный клапан купить Барнаул, предохранительный клапан купить Новосибирск, предохранительный клапан купить Сибирь" />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-6 items-stretch">
            ...
            <SafetyValveProductCard
              ...
              onRelatedOpen={() => setRelatedOpen(true)}
              ozonUrl="https://www.ozon.ru/product/klapan-predohranitelnyy-rs3132-3201218309/"
