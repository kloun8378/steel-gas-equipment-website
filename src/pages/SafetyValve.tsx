...
export default function SafetyValve() {
  ...
  return (
    ...
    <Helmet>
      <title>Предохранительный клапан ППЦЗ-12, ПК-32-Л купить — СтальПроКлапан</title>
      <meta name="description" content="Предохранительные клапаны для СУГ: ППЦЗ-12 (1,6 МПа, аналог REGO RS3132) и ПК-32-Л с запорным клапаном ЗК-32. АГЗС, ГНС, автоцистерны. В наличии в Барнауле. Цена от 9 659 ₽. Звоните!" />
