...
const CANONICAL = 'https://стальпро.com/safety-valve/ppcz-12/index.html';
...
export default function SafetyValvePPCZ12() {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>Предохранительный клапан ППЦЗ-12 купить — СтальПроКлапан</title>
        <meta
          name="description"
          content="Предохранительный клапан ППЦЗ-12 для СУГ. Рабочее давление 1,6 МПа. АГЗС, ГНС, автоцистерны. Цена 9 659 ₽. В наличии. Звоните!"
        />
        <meta
          name="keywords"
          content="предохранительный клапан ППЦЗ-12, ППЦЗ-12 купить, ППЦЗ-12 цена, ППЦЗ-12 характеристики, клапан для АГЗС, предохранительный клапан резервуар СУГ, ППЦЗ12, ППЦЗ, #ППЦЗ12, #ППЦЗ, #ППЦЗ-12"
        />
      ...
      <main className="container mx-auto px-4 md:px-6 py-6 sm:py-8">
        <div className="max-w-3xl mx-auto">
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-6">
            ...
            <a href="/safety-valve/index.html" className="hover:text-primary">Предохранительный клапан</a>
            <Icon name="ChevronRight" className="h-4 w-4" />
          ...
          <div className="flex flex-wrap gap-2 mb-8">
            ...
            <a href="/safety-valve/ppcz-12/index.html" className="px-3 py-1 rounded-full text-sm border border-primary text-primary hover:bg-primary hover:text-white transition-colors">ППЦЗ-12</a>
            <a href="/safety-valve/pk-32-l/index.html" className="px-3 py-1 rounded-full text-sm border border-gray-300 text-gray-600 hover:border-primary hover:text-primary transition-colors">ПК-32-Л</a>
          </div>
