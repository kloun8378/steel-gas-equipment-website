...
export default function FlangesType01B() {
  ...
  return (
    ...
    <Helmet>
      ...
      <meta name="description" content="Фланец стальной плоский приварной тип 01 ГОСТ 33259-2015 исполнение B для трубопроводов СУГ. Применение: АГЗС, ГНС, автоцистерны. СтальПроКлапан, Барнаул." />
      <meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1" />
      <meta name="keywords" content="фланец тип 01 исп B, фланец ГОСТ 33259-2015 тип 01, фланец плоский приварной исполнение B, фланец стальной приварной, фланец для СУГ, СтальПроКлапан Барнаул" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <section className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8 mb-8 max-w-3xl mx-auto">
          ...
          <p className="text-gray-600 leading-relaxed">
            Применяется на объектах СУГ — АГЗС, ГНС, автоцистерны и стационарные резервуары. Уточнить наличие конкретных типоразмеров и цены можно у наших менеджеров.
          </p>
        </section>
