...
export default function Blog() {
  ...
  return (
    <>
    <Helmet>
      <title>Блог о промышленной газовой арматуре СУГ — СтальПроКлапан, Барнаул</title>
      <meta name="description" content="Статьи и новости о промышленных клапанах СУГ для АГЗС, ГНС. Техническая информация о ППЦЗ-12, ТПА11, насосном оборудовании. Советы по эксплуатации и обслуживанию от СтальПроКлапан." />
      <meta name="keywords" content="блог промышленные клапаны СУГ, статьи ППЦЗ-12, техническая информация промышленное газовое оборудование, АГЗС ГНС, СтальПроКлапан Барнаул" />
