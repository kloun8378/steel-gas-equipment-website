...
const techSpecs = [
  ...
  { label: 'Диаметр клапана, A (мм)', value: '69' },
  { label: 'Строительная длина, B (мм)', value: '35,3' },
  { label: 'Высота, C (мм)', value: '30,8' },
  ...commonSpecs.slice(4),
];
...
export default function SpeedValveDU25() {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>Скоростной межфланцевый клапан ТПА11-025 ДУ25 PN40 купить — СтальПроКлапан</title>
        <meta
          name="description"
          content="Скоростной межфланцевый клапан ТПА11-025 ДУ25 PN40 для СУГ. Аварийное отключение потока. АГЗС, ГНС, автоцистерны. Цена 5 592 ₽. В наличии. Звоните!"
        />
        <meta
          name="keywords"
        ...
        <meta
          ...
          content="Скоростной клапан межфланцевый ТПА11-025 ДУ25 для СУГ. Цена 5 592 ₽ с НДС. В наличии."
        />
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-6">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">
              Купить скоростной межфланцевый клапан ТПА11-025 ДУ25 PN40
            </h1>
          ...
          <SpeedValveProductCard
            id={PRODUCT_ID}
            name={PRODUCT_NAME}
            description="Компактный межфланцевый клапан ДУ25 для аварийного отключения СУГ на сливных линиях и локальных системах"
            price={PRODUCT_PRICE}
