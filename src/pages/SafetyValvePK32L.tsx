      ...
      <main className="container mx-auto px-4 md:px-6 py-6 sm:py-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap gap-2 mb-8">
            ...
            <a href="/safety-valve/ppcz-12/index.html" className="px-3 py-1 rounded-full text-sm border border-gray-300 text-gray-600 hover:border-primary hover:text-primary transition-colors">ППЦЗ-12</a>
            <a href="/safety-valve/pk-32-l/index.html" className="px-3 py-1 rounded-full text-sm border border-primary text-primary hover:bg-primary hover:text-white transition-colors">ПК-32-Л</a>
          </div>
          ...
          <SafetyValveDetails model="pk-32-l" />
          <SafetyValveFAQ model="pk-32-l" />
        </div>
      </main>
