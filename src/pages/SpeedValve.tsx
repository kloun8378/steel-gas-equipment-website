...
export default function SpeedValve() {
  ...
  return (
    ...
    <Helmet>
      ...
      <meta name="description" content="Скоростные клапаны ТПА11-025/032/040/050 для СУГ. Аналог VENGO, AZT, REGO. АГЗС, ГНС, автоцистерны. В наличии на складе в Барнауле. Доставка по РФ. Цена от 5 592 ₽. Звоните!" />
