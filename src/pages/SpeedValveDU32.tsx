...
const techSpecs = [
  ...
  { label: 'Диаметр клапана, A (мм)', value: '80' },
  { label: 'Строительная длина, B (мм)', value: '40' },
  { label: 'Высота, C (мм)', value: '37' },
  ...commonSpecs.slice(4),
];
...
const CANONICAL = 'https://стальпро.com/speed-valve/tpa11-032';
...
const productLd = JSON.stringify({
  ...
  image: PRODUCT_IMAGE,
  description:
    'Скоростной клапан ТПА11-032 ДУ32 для трубопроводов СУГ среднего диаметра — ГНС, узлы налива. Аварийное отключение потока за доли секунды. Аналог ZNW DN32.',
...
export default function SpeedValveDU32() {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>Скоростной межфланцевый клапан ТПА11-032 ДУ32 PN40 купить — аналог ZNW DN32</title>
        <meta
          name="description"
          content="Скоростной межфланцевый клапан ТПА11-032 ДУ32 PN40 для СУГ. Аварийное отключение потока. АГЗС, ГНС, автоцистерны. Аналог ZNW DN32. Цена 6 202 ₽. В наличии. Звоните!"
        />
        <meta
          name="keywords"
        ...
        <meta
          ...
          content="Скоростной клапан межфланцевый ТПА11-032 ДУ32 для СУГ. Аналог ZNW DN32. Цена 6 202 ₽ с НДС. В наличии."
        />
      ...
      <main className="container mx-auto px-4 md:px-6 py-6 sm:py-8">
        <div className="max-w-3xl mx-auto">
          ...
          <SpeedValveProductCard
            id={PRODUCT_ID}
            name={PRODUCT_NAME}
            description="Межфланцевый клапан ДУ32 для аварийного отключения СУГ на трубопроводах среднего диаметра — ГНС, узлы налива"
            price={PRODUCT_PRICE}
