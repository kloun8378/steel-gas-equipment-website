...
const CANONICAL = 'https://стальпро.com/speed-valve/tpa11-032/index.html';
...
export default function SpeedValveDU32() {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>Скоростной межфланцевый клапан ТПА11-032 ДУ32 PN40 купить — СтальПроКлапан</title>
        <meta
          name="description"
          content="Скоростной межфланцевый клапан ТПА11-032 ДУ32 PN40 для СУГ. Аварийное отключение потока. АГЗС, ГНС, автоцистерны. Цена 6 202 ₽. В наличии. Звоните!"
        />
        <meta
          name="keywords"
        ...
        <meta
          ...
          content="Скоростной клапан межфланцевый ТПА11-032 ДУ32 для СУГ. Цена 6 202 ₽ с НДС. В наличии."
        />
