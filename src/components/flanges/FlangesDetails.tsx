...
const usageItems = [
  { icon: "Link2", text: "Соединение трубопроводов, арматуры и промышленного оборудования по стандарту ГОСТ 33259-2015" },
    ...
    <div className="mt-10 space-y-8">
      ...
      <section className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8">
        ...
        <p className="text-gray-600 leading-relaxed mb-3">
          Фланцы стальные плоские приварные по ГОСТ 33259-2015 предназначены для разъёмного соединения трубопроводов, запорной арматуры и промышленного оборудования общего назначения.
        </p>
