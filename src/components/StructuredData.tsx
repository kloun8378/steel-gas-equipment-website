...
export default function StructuredData() {
  useEffect(() => {
    ...
    const productsSchema = {
      ...
      "description": "Промышленная газовая арматура и оборудование для АГЗС, ГНС и резервуаров СУГ",
      "itemListElement": [{
        "@type": "ListItem",
        "position": 1,
        "item": {
    ...
    const faqSchema = {
      ...
      "mainEntity": [{
        "@type": "Question",
        "name": "Какие типы промышленных газовых клапанов для СУГ вы производите?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Мы производим промышленные скоростные клапаны аварийного отключения, предохранительные клапаны, электромагнитные клапаны, а также комплектующие для газовой арматуры АГЗС и ГНС различных диаметров от ДУ15 до ДУ300."
        }
      }, {
        "@type": "Question",
