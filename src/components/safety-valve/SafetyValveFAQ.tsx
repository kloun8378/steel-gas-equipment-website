...
const faqItems = [
  ...
  },
  {
    ...
    answer: 'Средний срок службы клапана — не менее 15 лет. При необходимости замены отдельные комплектующие (пружину, золотник, фланцы) можно заказать отдельно в разделе «Комплектующие».',
  },
  {
...
export default function SafetyValveFAQ() {
  ...
  return (
    <section className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8 mt-8">
      <h2 className="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
        ...
        Частые вопросы о предохранительном клапане ППЦЗ-12
      </h2>
